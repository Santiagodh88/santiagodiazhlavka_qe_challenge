# QE Automation Coding Challenge
...
- Use any testing technology, automation framework or programming langugage you'd like;
- Fork this repository & Feel free to modify or add whatever you need;
- Please submit a link to your finished repository with your name in it;
- You will present your solution to the hiring panel during the technical interview round;
